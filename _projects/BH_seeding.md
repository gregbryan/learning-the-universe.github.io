...
Together with Aklant Bhowmick and Laura Blecha (Univ. of Florida), We have recently developed and implemented a new sub-grid model to seed SMBHs in cosmological simulations {% cite 2024MNRAS.531.4311B %}. In this approach, extremely high resolution simulations are employed, which can resolve the sites of SMBH formation, and that are then evolved to lower redshifts allowing these black holes to grow by accretion and mergers.  
...
This will enable direct testing of the various models proposed for the origin of SMBHs. Recent follow-up work has studied the populations of low-mass black holes and their observational signatures {% cite 2025MNRAS.538..518B %} {% cite 2026ApJ...997..187B %}.
