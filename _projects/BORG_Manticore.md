...
We are currently preparing inference results at even larger scales with the Manticore-Main, which will fold in data from SDSS (including BOSS), 2dFGRS, 2MRS, 6dFGRS and 2M++ {% cite McAlpine:2026b %}.
